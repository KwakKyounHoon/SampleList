                ...
                if (!TextUtils.isEmpty(message)) {
                    switch (messageType.getCheckedRadioButtonId()) {
                        case R.id.radio_send :
                            ...
                            sd.setPhoto(ContextCompat.getDrawable(MultiActivity.this, R.drawable.sample_0));
                            mAdapter.add(sd);
                            break;
                        case R.id.radio_receive :
                            ReceiveData rd = new ReceiveData();
                            rd.setMessage(message);
                            rd.setPhoto(ContextCompat.getDrawable(MultiActivity.this, R.drawable.sample_1));
                            mAdapter.add(rd);
                            break;
